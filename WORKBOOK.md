...
Author's Note → Prologue [PENDING] → Foundation (5) → Do's (17, #6–#22) → Don'ts (3, #23–#25) → Boundaries → Elephant → Quick Reference → Epilogue

---

## What's Done

- [x] All 25 pointers written and refined
- [x] Foundation 5 (Assume Good Intent) added
- [x] Old #20 (Respect Different Ways) absorbed into #7
- [x] 14-item repetition review completed
- [x] Quick Reference table (cheat sheet format)
- [x] Author's Note (gender-neutral, scope limitations)
- [x] Epilogue: Making This Guide Obsolete
- [x] Part Four: Boundaries
...
| 4 | Luck | wrong table at coffee shop | ❌ pending |
| 5 | Assume Good Intent | missed prescription | ❌ pending |
| 6 | Listen | pre-presentation meal | ❌ pending |
...
| 14 | Keep Checking In | quieter than usual | ❌ pending |
| 15 | Pillar | family situation / dinner nightly | ❌ pending |
| 16 | Flirt | breakfast/pyjamas | ❌ pending |
| 17 | Cute Routines | Sunday pancakes, sticky note in coat | ❌ pending |
| 18 | Share Life | random Tuesday text, dog sighting | ❌ pending |
| 19 | Flexibility in Lead | medical + tax season | ❌ pending |
| 20 | Earn Trust | call at 7 | ❌ pending |
...
4. **#15 Pillar** — Night after night: dinner on the table, dishes done, "How are you — really?" No fanfare. Just showing up.
5. **#16 Flirt** — Breakfast scene. Phone on the table. One partner steals a bite from the other's plate. Both laugh.
6. **#17 Cute Routines** — Sunday pancakes. The ritual, not the pancakes.
7. **#18 Share Life** — A tiny text about a dog on the street. The smile it creates.
8. **#9 Tone** — Same message, two deliveries. Panel contrast: the snap vs. the gentle ask.
9. **#24 Don't Keep Score** — The moment someone lists their sacrifices. The look on their partner's face. No words needed.
10. **#5 Assume Good Intent** — Partner comes home without the prescription. The two versions of the same moment: the accusation vs. the understanding.

**Status: Waiting on Jay's 15–20 real-life examples before illustrations can begin.**
...
- Could pair with the Quick Reference table as a two-page PDF

**Alternative:** Single-pointer deep-dives as free blog posts (see Blog Candidates below).
...
| "Listen — Really Listen" (#6) | Practical advice with a twist (remembered listening), very shareable |
| "The Elephant Gets Its Own Room" | Compact, takes a clear stance on consent in long-term relationships |
| "Making This Guide Obsolete" (Epilogue) | Beautiful, philosophical — works as a standalone essay |
| "Boundaries" (Part Four) | Could expand into its own long-form piece |

**Not recommended as standalone:** The Quick Reference (needs context), individual Do's mid-list (lose the cross-reference value).
...
*Next session: Start with "what examples can I share with you from my life?" — that unlocks the Ghibli strips and deepens the book.*
